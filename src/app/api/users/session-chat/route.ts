...
export async function POST(req: NextRequest) {
  try {
    ...
    console.log("✅ User fetched:", user.primaryEmailAddress?.emailAddress);
    ...
    const result = await db
      ...
      .values({
        ...
        allSuggestions: JSON.stringify(allSuggestions || []), // optional
    ...
    console.error("❌ Session insert error:", error.message, error.stack);
    return NextResponse.json(
...
export async function GET(req: NextRequest) {
  try {
    ...
    console.error("❌ Session fetch error:", error.message, error.stack);
    return NextResponse.json(
